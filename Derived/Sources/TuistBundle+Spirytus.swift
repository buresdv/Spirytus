...
/// Since Spirytus is a static library, the bundle containing the resources is copied into the final product.
    static let module: Bundle = {
        let bundleName = "Spirytus_Spirytus"
        ...
        fatalError("unable to find bundle named Spirytus_Spirytus")
    }()
}
// MARK: - Objective-C Bundle Accessor
@objc
public class SpirytusResources: NSObject {
